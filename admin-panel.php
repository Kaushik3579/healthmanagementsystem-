...
.custom-btn {
    ...
    display: flex; /* Align text and button horizontally */
    align-items: center; /* Vertically center text */
    height: 50px; /* Increase height of the button */
  ...
  <div class="col-md-4" style="max-width:25%; margin-top: 3%">
    <div class="list-group" id="list-tab" role="tablist">
        ...
        <a class="list-group-item list-group-item-action" href="#list-meet" id="list-pres-list" role="tab" data-toggle="list" aria-controls="home"> Meetings</a>
        <a href="self-care.php" class="btn btn-primary custom-btn">Self-Care</a>
...
<div class="tab-pane fade" id="app-hist" role="tabpanel" aria-labelledby="list-pat-list">
      ...
      <!-- Meetings Tab -->
<div class="tab-pane fade" id="list-meet" role="tabpanel" aria-labelledby="list-meet-list">
                        <!-- Meetings Table -->
                        <table class="table table-hover">
                            <!-- Table Header -->
                            <thead>
                            ...
                            <!-- Table Body -->
                            <tbody>
                                <!-- Replace Dummy Data with Dynamic Data -->
                                <tr>
                                    <td>1</td>
                                    <td>John Doe</td>
                                    <td>2024-03-30</td>
                                    <td>10:00 AM</td>
                                    <td> <a href="video.php" class="btn btn-primary">Call</a></td>
                                </tr>
